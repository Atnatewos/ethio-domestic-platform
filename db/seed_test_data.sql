...
async function seedTestData() {
  ...
  try {
    ...
    // ============================================
    // JOBS (STRICTLY VALIDATED AGAINST schema.sql ENUMS)
    // schedule_type: 'full_time', 'part_time'
    // housing_type: 'live_in', 'live_out'
    // ============================================
    console.log('💼 Inserting jobs...');
    const jobData = [
      // [worker_type, schedule, housing, salary_min, salary_max, working_hours, preferred_gender, min_experience, min_education, required_skills]
      ...
      ['maid','full_time','live_in',8000,12000,'flexible','female','5','secondary',['elderly_care']],       // FIXED: schedule is 'full_time'
      ['nanny','part_time','live_out',6000,9000,'morning','any','2','secondary',['childcare_toddlers']]    // FIXED: schedule is 'part_time'
    ];
